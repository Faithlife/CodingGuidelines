...
The convention composes [editorconfig](../editorconfig/README.md) with the fixed `csharp-editorconfig` managed section and reads the section text from a generated file that lives next to the convention. In this repository, [the local updater convention](../../.github/conventions/update-editorconfig-csharp/README.md) regenerates that file from [sections/csharp/editorconfig.md](../../sections/csharp/editorconfig.md). When it changes `.editorconfig`, it runs the packaged Copilot instructions and commits the result with the message `Update C# editorconfig settings.`.
