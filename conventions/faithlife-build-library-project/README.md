...
This [convention](https://github.com/Faithlife/RepoConventions) copies [files/Build.cs](files/Build.cs) and [files/Build.csproj](files/Build.csproj) into `tools/Build` when those files are missing.
